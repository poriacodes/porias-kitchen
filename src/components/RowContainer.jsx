...
const RowContainer = ({ flag, data, scrollValue }) => {
  ...
  return (
    <div
      ref={rowContainer}
      className={`w-full flex items-center gap-3 my-12 bg-rowBg2 scroll-smooth  ${
        flag
      ...
      {data && data.length > 0 ? (
        data.map((item) => (
          <div
            ...
            className="w-280 h-[175px] min-w-[280px] md:w-300 md:min-w-[300px] bg-cardOverlay rounded-lg py-5 px-5 my-12 backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative"
          >
            ...
            <div className="w-full flex flex-col items-end justify-end -mt-4">
              <p className="text-green-600 font-semibold text-base md:text-md">
                {item?.title}
              </p>
