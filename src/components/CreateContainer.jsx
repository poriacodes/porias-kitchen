...
const CreateContainer=()=> {
  ...
  return (
    ...
    <div className='flex items-center justify-center'>
      <div className='w-[90%] md:w-[50%] border border-primary rounded-lg p-4 flex flex-col items-center justify-center gap-4 '>
    ...
    <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
        ...
        <div className="flex items-center w-full">
          <button
            type="button"
            className=" mt-2 ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 px-12 py-2 rounded-lg text-lg text-white font-semibold"
            onClick={saveDetails}
          >
            Save
          </button>
